...
const projectData = [
  ...
  },
  {
    ...
    challenges:
      "A modern barbershop for modern people. Client can see barbers and their work, and so make first impression.",
  },
  ...
  },
  {
    ...
    challenges:
      "Static website made for tour enthusiast. Designed by Mališauskas studio.",
  },
  {
    id: "5",
    used: "C19 & it's vaccination tracking",
    github: "https://github.com/Galvotas/Kilo-PR.git",
    challenges:
      "COVID19 pandemic and it's vaccination tracking with interactive map and charts.",
  },
];
const skillsData = [
  {
...
window.addEventListener("click", (e) => {
  ...
  check(e, `card4`, `https://covidinho-892bd.web.app/`);
});
